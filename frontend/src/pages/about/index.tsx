      ...
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12">
          <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
            VNUK - Official higher education cooperation project between the two
            governments of Vietnam - UK and UK
          </h2>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            VNUK's training program is professionally consulted by professors
            from Aston University, UK - a strategic partner of VNUK introduced
            by the British Government and tasked with supporting VNUK.
            Currently, Aston University is ranked in the top 500 on both world
            university rankings including QS Global World Ranking and Time
            Higher Education (THE) 2022. In particular, according to THE
            ranking, Economics and Economics Aston University's business school
            is ranked 133rd in the world and Aston is among the top 1% of
            business schools in the world with three accreditations – AMBA,
            EQUIS and AACSB.
          </p>
        </div>
        <div className="w-full lg:w-6/12">
      ...
      <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
        <div className="w-full lg:w-6/12">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
            According to Assoc.Prof.Dr. Nguyen Thi Anh Tuyet – Dean of School of
            Environmental Science and Technology (INEST), Hanoi University of
            Science and Technology, promoting interdisciplinary research thereby
            developing knowledge and operating capacity in the circular economy
            was the topical topic, in accordance with the goals of sustainable
            development as well as the Newton Fund ‘s orientation of connection,
            building the research environment and funding. According to the Dean
            of INEST, forming a circular economic center in Vietnam was the
            right direction.
          </p>
          <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">
            At the seminar, VNUK Institute and partners (Institute of
            Environmental Science and Technology-Hanoi University of Science and
            Technology, Institute for Circular Economy Development - Vietnam
            National University Ho Chi Minh City, Danang Institute for
            Socio-Economic Development and Danang Business Incubator - DNES) had
            signed a cooperation agreement to develop training and research on
